...
CREATE TABLE ProyectoSistemaMatricula.unah.SeccionMatricula (
															  ...
															  FOREIGN KEY( idAsignatura,idSeccion) REFERENCES ProyectoSistemaMatricula.unah.Seccion(idAsignatura, idSeccion),
